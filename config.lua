...
Config.Jobs = {
    {job = 'rancher', grade = 0},
    {job = 'rancher1', grade = 0},
    {job = 'rancher2', grade = 0},
    {job = 'rancher3', grade = 0},
    {job = 'rancher4', grade = 0}
}
...
Config.SlaughterHouses = {{
    ...
    name = "Jatka Riggs Station",
    model = "a_m_m_rancher_01",
    npcCoords = vector3(-1086.818237, -576.229309, 82.331245),
    heading = 300.0,
    blip = true,
    blipName = "Jatka Riggs Station",
    blipSprite = 423351566
},
-- {
--     name = "Jatka Emerald SMAZAT",
--     model = "a_m_m_rancher_01",
--     npcCoords = vector3(1396.918579, 307.810181, 87.329704),
--     heading = 300.0,
--     blip = true,
--     blipName = "Jatka Emerald SMAZAT",
--     blipSprite = 423351566
-- }
}
...
Config.Animals = {
    ...
    --     name = "Goat",
    --     price = 10,
    --     model = "a_c_goat_01", -- a_c_bighornram_01
    --     m_model = "a_c_bighornram_01",
    --     health = 100,
    --     adultAge = 3,
    --     WalkOnly = false,
    --     offsetX = 0.0,
    --     offsetY = 2.0,
    --     offsetZ = 0.0,
    --     food = 2, -- consume food per update from trough
    --     water = 3, -- consume water per update from trough
    --     foodMax = 48,
    --     waterMax = 72,
    --     kibble = "product_carrot",
    --     poop = "p_poop01x",
    --     poopChance = 0.3,
    --     kibbleFood = 14,
    --     dieAge = 12,
    --     pregnancyTime = 1,
    --     pregnancyChance = 20,
    --     noFuckTime = 1, -- počet dní mezi porodem a dalším množením
    --     product = {{
    --         name = "Kozí Mléko",
    --         item = "animal_goat_milk",
    --         prop = "",
    --         gather = 2, -- 1 = kill 2 = gather, 3 =pickup
    --         amount = 1,
    --         maxAmount = 3,
    --         lifetime = 60 * 60 * 3, -- time in s
    --         tool = Config.emptyWaterItem,
    --         anim = Config.Animation.shave,
    --         chance = 100,
    --         gender = "female"
    --     }, {
    --         name = "Zvířecí roh",
    --         item = "animal_horn",
    --         prop = "",
    --         gather = 1, -- 1 = kill 2 = gather, 3 =pickup
    --         amount = 1,
    --         lifetime = 60 * 60 * 3, -- time in s
    --         tool = "",
    --         anim = Config.Animation.shave,
    ...
    --     offsetY = 2.0,
    --     offsetZ = 0.0,
    --     food = 25, -- consume food per update from trough
    --     water = 25, -- consume water per update from trough
    --     foodMax = 600,
    --     waterMax = 360,
    --     kibble = "animal_silage",
    --     kibbleFood = 200,
    --     poop = "s_horsepoop01x",
    --     poopChance = 0.4,
    --     dieAge = 20,
    ...
    --     offsetY = 2.0,
    --     offsetZ = 0.0,
    --     food = 1, -- consume food per update from trough
    --     water = 1, -- consume water per update from trough
    --     foodMax = 24,
    --     waterMax = 24,
    --     kibble = "product_wheat",
    --     kibbleFood = 10,
    --     poop = "p_poop01x",
    --     poopChance = 0.1,
    --     dieAge = 10,
    ...
    --         item = "animal_egg",
    --         prop = "p_egg01x",
    --         gather = 3, -- 1 = kill 2 = gather, 3 =pickup
    --         amount = 1,
    --         maxAmount = 10,
    --         lifetime = 60 * 60 * 3, -- time in s
    --         tool = Config.GatherTool,
    --         gender = "female",
    --         anim = Config.Animation.shave,
    --         chance = 30
    --     }, {
    --         name = "Maso",
    --         item = "animal_chicken_meat",
    --         prop = "",
    --         gather = 1, -- 1 = kill 2 = gather, 3 =pickup
    --         amount = 1,
    --         lifetime = 60 * 60 * 3, -- time in s
    ...
    --     offsetZ = 0.0,
    --     food = 2, -- consume food per update from trough
    --     water = 2, -- consume water per update from trough
    --     foodMax = 48,
    --     waterMax = 48,
    --     kibble = "product_grass",
    --     kibbleFood = 14,
    --     poop = "p_sheeppoop01x",
    --     poopChance = 0.1,
    --     dieAge = 12,
    ...
    --         lifetime = 60 * 60 * 3, -- time in s
    --         chance = 60,
    --         tool = Config.ShaveTool,
    --         anim = Config.Animation.shave,
    --         gender = nil
    --     }, {
    --         name = "Ovcí mléko",
    --         item = "animal_sheep_milk",
    --         prop = "",
    --         gather = 1, -- 1 = kill 2 = gather, 3 =pickup
    --         amount = 1,
    --         lifetime = 60 * 60 * 3, -- time in s
